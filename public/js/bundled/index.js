...
if (photoInput) // Tambahkan event listener untuk perubahan pada input file
...
if (userPasswordForm) userPasswordForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _updateSetting.updateSetting)({
        passwordCurrent,
        password,
        passwordConfirm
    }, "password");
...
},{"./login":"7yHem","./mapbox":"3zDlz","./updateSetting":"6GcZk","./stripe":"10tSC"}],"7yHem":[function(require,module,exports) {
...
const showAlert = (type, msg)=>{
    ...
    window.setTimeout(hideAlert, 5000); //Hide alert akan dieksekusi setelah 5 detik
};
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert":"kxdiQ"}]},["aC5kS","f2QDv"], "f2QDv", "parcelRequire11c7")
